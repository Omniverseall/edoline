...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  ...
  en: {
    ...
    // Voting and other features
    votingTitle: 'Working Groups and Committees',
    votingSubtitle: 'Organize transparent and secure votings',
    votingDescription: 'Our e-voting solution ensures reliability and convenience of voting in group decision making.',
    transparentPath: 'Transparent Route',
    mobileVoting: 'Document History',
    speedUp: 'Speed Up the Process',
    notifications: 'Status Notification',
    // Electronic Signature
    eSignTitle: 'Electronic Signature E-IMZO',
    ...
    contactPhone: '+998 90 123 45 67',
    contactEmail: 'info@edoline.uz',
    contactAddress: 'Tashkent, 9th passage, A. Qahhor St., 1A',
    ...
    workflowVoteTitle: 'Working Groups and Committees',
    workflowVoteFeat1Title: 'Protocol Creation',
    workflowVoteFeat1Desc: 'Easy creation and configuration of protocol procedures',
    workflowVoteFeat2Title: 'Voting',
    workflowVoteFeat2Desc: 'Voting confirmation with E-IMZO digital signature',
    workflowVoteFeat3Title: 'Real-time Results',
    workflowVoteFeat3Desc: 'Instant processing and reflection of results',
    ...
    workflowHRTitle: 'Personnel Documents',
    ...
    workflowControlTitle: 'Knowledge Base',
    workflowControlFeat1Title: 'Document Publishing',
    workflowControlFeat1Desc: 'Ability to publish documents inside and outside the organization',
    workflowControlFeat2Title: 'Document Protection',
    ...
    workflowControlFeat3Desc: 'Changing access code of each document and providing one-time access',
  },
  uz: {
