...
import { ShieldCheck, Cloud, HardDrive, UserCheck, Phone, Mail, Layers, Lock, Key } from 'lucide-react'; 
                ...
                <ul className="space-y-3">
                  {option.features.map((featureKey, fIndex) => (
                     <li key={fIndex} className="flex items-start space-x-3">
                      <div id='contact-section' className={`w-5 h-5 rounded-full ${index === 0 ? 'bg-blue-500' : 'bg-teal-500'} flex items-center justify-center mt-1 flex-shrink-0`}>
